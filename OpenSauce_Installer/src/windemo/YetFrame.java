 ...
 * @author neste
 */
public class YetFrame extends javax.swing.JFrame {

    /**
     * Creates new form YetFrame
     */
    public YetFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("I accept the AGBs of this program!");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("Some text before the installation beginns :)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int x = JOptionPane.showOptionDialog(null, "Do you really want to cance the installation?",
                "Information",
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (!(jCheckBox1.isSelected())) {
            JOptionPane.showMessageDialog(this, "You need to aggre to the AGBs!");
        } else {
            this.dispose();
            InstallerFrame yes = new InstallerFrame();
            yes.pack();
            yes.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YetFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
